    ...
    private ExplorerTreeNode[] getData() {
        if (data == null) {
            ...
            data.addAll(Arrays.asList(new ExplorerTreeNode[] {
                    ...
                    new CommandTreeNode("New Enterprise Samples", "smartgwtee-category", "root", "pieces/16/cube_yellow.png", new com.smartgwt.sample.showcase.client.SmartGwtEECommand(), true, idSuffix),
                ...
                new ExplorerTreeNode("Inline Operator Filter", "grid-sortfilter-inline-operator-filter", "grid-filter-category", null, new GridInlineOperatorFilterSample.Factory(), true, idSuffix, "6.0"),
                    ...
                    new ExplorerTreeNode("Sounds", "basics-sounds-category", "basics-category", "pieces/16/cube_blue.png", null, true, idSuffix),
